...
struct WithPrimitivesMap: Equatable {
    ...
    static func read(json: JSON) -> WithPrimitivesMap {
        ...
        longs:
        json["longs"].dictionary.map { $0.mapValues { $0.intValue } },
        floats:
        json["floats"].dictionary.map { $0.mapValues { $0.floatValue } },
        doubles:
        json["doubles"].dictionary.map { $0.mapValues { $0.doubleValue } },
        booleans:
        json["booleans"].dictionary.map { $0.mapValues { $0.boolValue } },
        strings:
