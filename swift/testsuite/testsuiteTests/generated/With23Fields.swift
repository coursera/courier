...
/**
    Scala's tuple limit is 22. Here we test beyond that limit.
*/
public struct With23Fields: Serializable {
    ...
    public static func readJSON(json: JSON) throws -> With23Fields {
        return With23Fields(
            ...
            field23: try json["field23"].optional(.Number).int
        )
    }
    public func writeData() -> [String: AnyObject] {
        ...
        if let field23 = self.field23 {
            dict["field23"] = field23
        }
        return dict
    }
}
