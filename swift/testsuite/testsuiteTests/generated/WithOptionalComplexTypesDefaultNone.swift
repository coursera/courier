...
public struct WithOptionalComplexTypesDefaultNone: JSONSerializable, DataTreeSerializable {
    ...
    public static func readJSON(json: JSON) -> WithOptionalComplexTypesDefaultNone {
    ...
    public static func readData(data: [String: AnyObject]) -> WithOptionalComplexTypesDefaultNone {
        return readJSON(JSON(data))
    }
    public func writeData() -> [String: AnyObject] {
