...
public struct WithOptionalComplexTypesDefaultNone: Serializable, Equatable {
    ...
    public static func readJSON(json: JSON) throws -> WithOptionalComplexTypesDefaultNone {
...
public func ==(lhs: WithOptionalComplexTypesDefaultNone, rhs: WithOptionalComplexTypesDefaultNone) -> Bool {
    return (
...
public func ==(lhs: WithOptionalComplexTypesDefaultNone.Union, rhs: WithOptionalComplexTypesDefaultNone.Union) -> Bool {
    switch (lhs, rhs) {
