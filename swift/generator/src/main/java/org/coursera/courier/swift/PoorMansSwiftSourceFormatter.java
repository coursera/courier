...
/**
 * Cleans up Swift source code generated by a string template engine.
 *
 * Ideally, we would use a grammar aware formatter for Swift.
 * Until we find something good, we'll use these basic heuristics:
 *
 ...
 *
 */
public class PoorMansSwiftSourceFormatter {
