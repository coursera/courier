...
/**
 * Abstracts away the data binding generator implementation (batch vs. incremental).
 */
public interface GeneratorRun {
  String[] getSourcesToParse();

  DefaultGeneratorResult buildResult(
