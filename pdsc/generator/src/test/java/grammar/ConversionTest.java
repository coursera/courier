...
import org.coursera.courier.SchemaToPdscEncoder;
...
public class ConversionTest {
  ...
  private static class CourierSchema {
    ...
    public DataMap pdscSchema() throws IOException {
      JacksonDataCodec dataCodec = new JacksonDataCodec();
  ...
  private static class PdscSchema {
    ...
    public static PdscSchema load(String schemaName) throws IOException {
      ...
      return fromJson(new String(Files.readAllBytes( Paths.get(pegasusPath.toString(), relPath))));
    }

    public static PdscSchema fromJson(String jsonString) throws IOException {
      JacksonDataCodec dataCodec = new JacksonDataCodec();
