...
Internet applications often involve multiple languages communicating via JSON or some other structured data protocol.  Mobile development might be done in Swift, Objective-C and Java, web development in Javascript, and server-side development in another language, such as Scala.
