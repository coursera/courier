...
Building internet applications often requires that multiple languages communicate via JSON or some other structured data protocol.  Mobile development might be done in Swift, Objective-C and Java, web development in Javascript, and server-side development in another language, such as Scala.

Schema deriven data model makes this easier:

* Simply way for all these languages to share a common understanding of the structure of the data they read and write.
