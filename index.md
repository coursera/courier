...
Building internet applications requires messaging structured data between servers and clients written in different programming languages.  Mobile development might be done in Swift, Objective-C and Java, web development in Javascript, and server-side development in another language, such as Scala.
