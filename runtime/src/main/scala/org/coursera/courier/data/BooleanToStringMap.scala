...
@Generated(value = Array("BooleanToStringMap"), comments="Courier Data Template.", date = "Fri Jul 10 10:23:12 PDT 2015")
 final class BooleanToStringMap(private val dataMap: DataMap)
  ...
  private[this] 
  def coerceInput(any: AnyRef): String = {
...
object BooleanToStringMap {
  ...
  def apply(dataMap: DataMap, conversion: DataConversion): BooleanToStringMap = {
    new BooleanToStringMap(DataTemplates.makeImmutable(dataMap, SCHEMA, conversion))
  }
  ...
  private 
  def coerceOutput(value: String): AnyRef = {
