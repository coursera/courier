...
@Generated(value = Array("StringArray"), comments = "Courier Data Template.", date = "Sat May 30 12:21:42 PDT 2015")
final class StringArray(private val dataList: DataList)
  ...
  private[this] def lookup(idx: Int) = {
    ...
    dataList.get(idx).asInstanceOf[java.lang.String]

  }

  override def apply(idx: Int): String = lookup(idx)
