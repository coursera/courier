...
final class Wrapper private (private val dataMap: DataMap)
  ...
  override def copy(dataMap: DataMap, conversion: DataConversion): Wrapper = {
    new Wrapper(DataTemplates.makeImmutable(dataMap, conversion))
  }

  override def clone(): Wrapper = this
}
